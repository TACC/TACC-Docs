...
!!! warning
	The `$SCRATCH` file system, as its name indicates, is a **temporary storage space**.  Files that have not been accessed&#42; in ten days are subject to purge.  <p>**Deliberately modifying file access time, using any method, tool, or program, for the purpose of circumventing purge policies is prohibited.**
