...
1. **Step 2. Install MiniForge**

Do this within an idev session.
...
You should be in the **scratch** folder for Frontera. 

	Computer Resource | single-node GPU idev command
	-- | --
    Frontera| idev -N 1 -n 1 -p rtx-dev -t 02:00:00
	Stampede3| h100
	Vista | idev yada
  	Lonestar6 | idev yada
...
1. **Step 4. Install Pytorch in Conda Environment**
...
1. **Step 5. Clone the Pytorch Repository**
...
1. **Step 6. CD into the ddp tutorial series folder**
...
1. **Step 7. Run multigpu_torchrun.py**
...
1. **Step 1. Create an empty YAML File**

Using your favorite editor, create a file named 'environment.yaml' and place it XXXX directory,.

1. **Step 2. Add your environment variables to your YAML File**
...
1. **Step 3. Create your Conda environment with environment.yml**
