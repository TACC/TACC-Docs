...
1. **[I can log into the TACC User Portal, but this same password doesn't work on Frontera/Lonestar6/Stampede3/Vista. How can I login to my machine?](#q1)**  
1. **[A member of my group has left - how do i get access/ownership to those files?](#q2)**   
1. **[My allocated work space $WORK of 1TB isn't enough.  I need more.  Can I have more?](#q3)**   
1. **[I can't login because of "Improper ssh Configuration!" How do I fix this?](#q4)**   
1. **[How do I share my files with my project members?](#q5)**   
1. **[My job is currently running but it's going to run out of time.  Can you give it more time?](#q6)**   
1. **[I need more than 48 hours to run my job, can you allow an extension or give me an exception?](#q7)**   
1. **[Queue wait times are so long.  Is there anything I can do to help my job run faster??](#q8)**   
1. **[My job has been waiting in the queue, but I see a bunch of idle nodes.  Why isn't my job running?](#q9)**  
...
A: The most likely cause is that you don't have an allocation on that particular machine.  You can only log on to those resources where you have an allocation.  You can monitor your allocations on the [TACC User Portal](https://tacc.utexas.edu/portal/projects). 
...
<a id="q8"></a>
#### Q. **[My job has been waiting in the queue, but I see a bunch of idle nodes in the same partition.  Why isn't my job running?](#q9)**  
